                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="adres" id="adres"
                                           value="{{$kullanici_detay->adres }}" required>
                                    {{--adres, telefon ve ceptelefonu bilgileri kullanıcı_datey içince yer aldığı için bunu odemeCont. içerisinde çektiğimiz detay verisi üzerinden çekiyoruz--}}
                                </div>
                            </div>
                        </div>
                        <div class="row">
